...
exports.SimpleRAGService = void 0;
const openai_1 = __importDefault(require("openai"));
const Email_1 = require("../models/Email");
class SimpleRAGService {
    static async generateReplySuggestions(emailId) {
        try {
    ...
    static findRelevantContexts(subject, body) {
    ...
    static generateSimpleSuggestions(email, _contexts) {
        const suggestions = [];
    ...
    static async storeContext(content, type) {
        const newContext = {
            id: `custom_${Date.now()}`,
            content,
            type
    ...
    static updateContext(id, content) {
    ...
    static async generateAdvancedReply(emailContent, contexts) {
        try {
...
exports.SimpleRAGService = SimpleRAGService;
SimpleRAGService.contexts = [
    {
        id: 'job_application',
        type: 'outreach',
...
SimpleRAGService.openai = new openai_1.default({
    apiKey: process.env.OPENAI_API_KEY || 'demo-key'
});
//# sourceMappingURL=simpleRAGService.js.map